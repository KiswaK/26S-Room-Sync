...
def get_all_listings():
    ...
    try:
        ...
        cursor.execute('''SELECT Listing.*, 
                       ...
                       LEFT JOIN Broker ON Listing.brokerID = Broker.brokerID''')
...
#     cursor = get_db().cursor(dictionary = True)
#     try:
#         current_app.logger.info(f'GET /sienna/admin/landlords')
...
#     cursor = get_db().cursor(dictionary = True)
#     try:
#          current_app.logger.info(f'PUT /sienna/admin/landlords/{landlord_id}')
